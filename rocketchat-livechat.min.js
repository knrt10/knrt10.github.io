...
}, function (e, t, n) { "use strict"; n.r(t); var i = n(0), o = n.n(i); const r = () => { }; window.RocketChat = window.RocketChat || { _: [] }; const s = {}; let a, c, u, l, d = [], f = !1, h = !1; const p = ["chat-maximized", "chat-minimized", "chat-started", "chat-ended", "pre-chat-form-submit", "offline-form-submit"], m = new o.a; function v(e, t) { return -1 !== p.indexOf(e) && m.on(e, t) } function y(e, t) { void 0 !== t ? m.emit(e, t) : m.emit(e) } function w(e, t) { if (!f) return d.push([e, t]); const n = { src: "rocketchat", fn: e, args: t }; c.contentWindow.postMessage(n, "*") } const g = e => { h && e ? (l = document.documentElement.scrollTop, u = document.body.style.cssText, document.body.style.cssText += `overflow: hidden; height: 100%; width: 100%; position: fixed; top: ${l}px;`) : (document.body.style.cssText = u, h && (document.documentElement.scrollTop = l)), e ? (a.style.left = h ? "0" : "auto", a.style.width = h ? "100%" : "397px", a.style.height = h ? "100%" : "627px") : (a.style.left = "auto", a.style.width = "86px", a.style.height = "86px") }, b = () => { "opened" !== a.dataset.state && (g(!0), a.dataset.state = "opened", c.focus(), y("chat-maximized")) }; function x() { "closed" !== a.dataset.state && (g(!1), a.dataset.state = "closed", y("chat-minimized")) } const E = { popup: null, ready() { f = !0, d.length > 0 && (d.forEach(function (e) { w.apply(this, e) }), d = []) }, minimizeWindow() { x() }, restoreWindow() { E.popup && !0 !== E.popup.closed && (E.popup.close(), E.popup = null), b() }, openPopout() { x(), E.popup = window.open(`${s.url}${s.url.lastIndexOf("?") > -1 ? "&" : "?"}mode=popout`, "livechat-popout", "width=365, height=525, toolbars=no"), E.popup.focus() }, openWidget() { b() }, removeWidget() { document.body.removeChild(a) }, callback(e, t) { y(e, t) } }; function L(e) { w("pageVisited", { change: e, location: JSON.parse(JSON.stringify(document.location)), title: document.title }) } const O = { href: null, title: null }, R = e => { e && (s.url = e, (e => { (a = document.createElement("div")).className = "rocketchat-widget", a.style.position = "fixed", a.style.width = "86px", a.style.height = "86px", a.style.maxHeight = "100vh", a.style.bottom = "0", a.style.right = "0", a.style.zIndex = "12345", a.dataset.state = "closed"; const t = document.createElement("div"); t.className = "rocketchat-container", t.style.width = "100%", t.style.height = "100%", (c = document.createElement("iframe")).id = "rocketchat-iframe", c.allowTransparency = "true", c.src = e, c.style.width = "100%", c.style.height = "100%", c.style.border = "none", c.style.backgroundColor = "transparent", t.appendChild(c), a.appendChild(t), document.body.appendChild(a); const n = ({ matches: e }) => { a && (h = e, g("opened" === a.dataset.state), w("setExpanded", h)) }, i = window.matchMedia("screen and (max-device-width: 480px)"); i.addListener(n), n(i) })(e), window.addEventListener("message", e => { if ("object" == typeof e.data && void 0 !== e.data.src && "rocketchat" === e.data.src && void 0 !== E[e.data.fn] && "function" == typeof E[e.data.fn]) { const t = [].concat(e.data.args || []); r(`api.${e.data.fn}`, ...t), E[e.data.fn].apply(null, t) } }, !1), setInterval(() => { document.location.href !== O.href && (L("url"), O.href = document.location.href), document.title !== O.title && (L("title"), O.title = document.title) }, 800)) }; void 0 !== window.initRocket && (console.warn("initRocket is now deprecated. Please update the livechat code."), R(window.initRocket[0])), void 0 !== window.RocketChat.url && R(window.RocketChat.url); const k = window.RocketChat._; window.RocketChat = window.RocketChat._.push = function (e) { e.call(window.RocketChat.livechat) }, window.RocketChat.livechat = { pageVisited: L, setCustomField: function (e, t, n) { void 0 === n && (n = !0), w("setCustomField", [e, t, n]) }, setTheme: function (e) { w("setTheme", e) }, setDepartment: function (e) { w("setDepartment", e) }, clearDepartment: function () { w("clearDepartment") }, setGuestToken: function (e) { w("setGuestToken", e) }, setGuestName: function (e) { w("setGuestName", e) }, setGuestEmail: function (e) { w("setGuestEmail", e) }, registerGuest: function (e) { w("registerGuest", e) }, setLanguage: function (e) { w("setLanguage", e) }, onChatMaximized(e) { v("chat-maximized", e) }, onChatMinimized(e) { v("chat-minimized", e) }, onChatStarted(e) { v("chat-started", e) }, onChatEnded(e) { v("chat-ended", e) }, onPrechatFormSubmit(e) { v("pre-chat-form-submit", e) }, onOfflineFormSubmit(e) { v("offline-form-submit", e) } }, k.forEach(e => { e.call(window.RocketChat.livechat) }) }]);
